...
public class Vec3
{
    ...
    {
        double d0 = (double)MathHelper.sqrt((float) (this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord));
    ...
    {
        return (double)MathHelper.sqrt((float) (this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord));
    }
